...
export default function Hero() {
    return (
        <section className='font-roboto bg-darkmain-800 '>
            <div className='grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:pb-16 lg:pt-32 lg:grid-cols-12'>
                <div className='mr-auto place-self-center lg:col-span-7'>
                    ...
                    <p className='max-w-2xl mb-6 font-light text-white lg:mb-8 md:text-lg lg:text-lg '>
                    ...
                    <a
                        href='#'
                        className='inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bgGradient '>
                        Telusuri
                        <svg
